		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "zodata",
									"targetURL": "#zodatazodata-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zodatazodata-display": {
								"semanticObject": "zodatazodata",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zodata.zodata",
									"url": sap.ui.require.toUrl("zodata/zodata")
								}
							}
						}
					}
